...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/css/imageoption.css">
</head>
...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <select id="novedad" class="form-control" multiple>
            ...
            <div class="col">
                <div class="row h-100">
                    <div class="col d-flex flex-row-reverse">
                        <button id="misDatos" class="btn btn-orange mx-1 mt-auto disabled">Mis datos</button>
                        <button id="registrarse" class="btn btn-orange mx-1 mt-auto d-none" data-toggle="tooltip" data-placement="bottom" title="Botón temporal/Primera vez al registrarse">Registrarse</button>
                        <button id="cerrarSesionProp" class="btn btn-orange mx-1 mt-auto">Salir</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Completado del registro del propietario</h4>
                    ...
                    <div class="row">
                        <div class="col my-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group row">
                                        <label class="col-2 col-form-label">Chasis:</label>
                                        <div class="col">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body px-0">
                    <div class="row mx-2">
                        <div class="col">
                            <table class="table table-striped table-bordered table-hover w-90" id="tablavehiculos"></table>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <script src="/assets/js/scriptpropietario.js"></script>
</body>
